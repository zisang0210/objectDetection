...
General tensorflow implementation of convolutional You Only Look Once/YOLO detection
models.
"""
...
class YOLOMetaArch(model.DetectionModel):
  ...
  def __init__(self,
    ...
    """
    super(YOLOMetaArch, self).__init__(num_classes=box_predictor.num_classes)
    self._is_training = is_training
