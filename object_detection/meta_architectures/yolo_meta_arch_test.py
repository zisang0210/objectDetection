...
"""Tests for object_detection.meta_architectures.yolo_meta_arch."""
import functools
import numpy as np
...
class FakeYOLOFeatureExtractor(yolo_meta_arch.YOLOFeatureExtractor):

  def __init__(self):
    super(FakeYOLOFeatureExtractor, self).__init__(
        is_training=True,
        depth_multiplier=0,
        min_depth=0,
        pad_to_multiple=1,
