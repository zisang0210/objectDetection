...
import object_detection.protos.yolo_pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='object_detection/protos/model.proto',
  package='object_detection.protos',
  serialized_pb=_b('\n#object_detection/protos/model.proto\x12\x17object_detection.protos\x1a)object_detection/protos/faster_rcnn.proto\x1a!object_detection/protos/ssd.proto\x1a\"object_detection/protos/yolo.proto\"\xb1\x01\n\x0e\x44\x65tectionModel\x12:\n\x0b\x66\x61ster_rcnn\x18\x01 \x01(\x0b\x32#.object_detection.protos.FasterRcnnH\x00\x12+\n\x03ssd\x18\x02 \x01(\x0b\x32\x1c.object_detection.protos.SsdH\x00\x12-\n\x04yolo\x18\x03 \x01(\x0b\x32\x1d.object_detection.protos.YoloH\x00\x42\x07\n\x05model')
  ,
  dependencies=[object_detection.protos.faster_rcnn_pb2.DESCRIPTOR,object_detection.protos.ssd_pb2.DESCRIPTOR,object_detection.protos.yolo_pb2.DESCRIPTOR,])
...
_DETECTIONMODEL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='yolo', full_name='object_detection.protos.DetectionModel.yolo', index=2,
...
_DETECTIONMODEL.fields_by_name['yolo'].message_type = object_detection.protos.yolo_pb2._YOLO
...
_DETECTIONMODEL.oneofs_by_name['model'].fields.append(
  _DETECTIONMODEL.fields_by_name['yolo'])
_DETECTIONMODEL.fields_by_name['yolo'].containing_oneof = _DETECTIONMODEL.oneofs_by_name['model']
